  ...
  <div class="info">
    <div class="header">
      ...
      <div class="box-btns">
        ...
        <el-button small link type="primary" @click="handleUpdate">删除</el-button>
    ...
    <div class="tab-list">
      <el-descriptions :column="2" border>
        <el-descriptions-item :label="'集团名称'" label-align="center" align="center" width="150px"
          label-class-name="my-label" class-name="my-content">{{selectItem?.data?.team.name}}</el-descriptions-item>
        <el-descriptions-item :label="'集团编码'" label-align="center" align="center" width="150px"
